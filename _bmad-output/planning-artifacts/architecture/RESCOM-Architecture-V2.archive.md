...
status: superseded
canonical: false
superseded_by: architecture-project-rescom-2026-08-08/ARCHITECTURE-SPINE.md
---

> [!WARNING]
> **Historical proposal — non-canonical.** This document is preserved for rationale only. It does not override the canonical authority chain in `architecture-project-rescom-2026-08-08/ARCHITECTURE-SPINE.md`. In particular, its reduced-confidence External assessment, replacement of `FraudLog`, and independent worker-service implications are superseded. Do not use its schema examples for migration work.
